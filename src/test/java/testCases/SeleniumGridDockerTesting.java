...
public class SeleniumGridDockerTesting {
	...
	public void browseInitialization(String os, String br) throws IOException {
		...
		FileReader file=new FileReader("C:\\Users\\Sasikumar\\eclipse-workspace\\DemoProjectRA\\src\\test\\resources\\config.properties");	
		 p=new Properties();
			p.load(file);
